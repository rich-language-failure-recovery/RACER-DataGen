...
from racer_datagen.models.peract_official import PreprocessAgent2
...
def get_eval_parser():
    ...
    parser.add_argument("--skip-wypt", action="store_true")
    parser.add_argument("--perturb-number", type=int, default=1)
